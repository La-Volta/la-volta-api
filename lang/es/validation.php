...
return [
    'required' => ':attribute',
    'attributes' => [
        'name' => 'Cal omplir el nom.',
        'lastname' => 'Cal omplir el cognom.',
        'email' => 'No sembla una adreça de correu electrònic (manca @).',
        'password' => 'Contrasenya és massa curta (el mínim són 8 caràcters).'
    ],
    'min'                  => [
        'string'  => ':attribute',
